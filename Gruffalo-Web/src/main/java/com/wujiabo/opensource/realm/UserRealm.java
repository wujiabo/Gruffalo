package com.wujiabo.opensource.realm;
...
import com.wujiabo.opensource.utils.SpringUtils;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		User user = SpringUtils.getBean(RbacProvider.class).getUserByLoginName(username);
		if (user == null) {
		...
		SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(
				new ShiroUser(user.getId(), user.getLoginName(), user.getUserName()), // 用户名
				user.getPassword(), // 密码
	...
	public static class ShiroUser implements Serializable {
		...
		public ShiroUser(Long id, String loginName, String userName) {
			this.id = id;
